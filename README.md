...
Dessa forma, existe a necessidade de orientar os estudantes sobre como elaborar instruções para ferramentas de Inteligência Artificial de maneira clara, objetiva e contextualizada.
...
O projeto utiliza o GitHub para organização, desenvolvimento e compartilhamento dos materiais produzidos.

As ferramentas de Inteligência Artificial serão utilizadas como apoio durante a elaboração, análise e aprimoramento dos conteúdos apresentados no projeto.
